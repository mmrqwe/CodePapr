...
\`\`\``,
  ...
  },
  {
    name: 'compactor',
    description: {
      'zh-CN': '上下文压缩器：把长会话压缩成可恢复的上下文检查点（仅供运行时压缩管线内部使用）',
      'zh-TW': '上下文壓縮器：把長會話壓縮成可恢復的上下文檢查點（僅供執行階段壓縮管線內部使用）',
      en: 'Context compactor: compress a long conversation into a recoverable checkpoint (internal use by the compaction pipeline)',
    },
    mode: 'subagent',
    model: 'fast',
    tools: {},
