...
#[tauri::command]
pub(crate) fn check_external_path(
...
#[tauri::command]
pub(crate) fn get_external_access_policy() -> Result<ExternalAccessPolicy, String> {
    db::load_external_access_policy()
}

#[tauri::command]
pub(crate) fn set_external_access_yolo(enabled: bool) -> Result<ExternalAccessPolicy, String> {
...
#[tauri::command]
pub(crate) fn grant_external_access(
    workspace_path: String,
    raw_path: String,
    scope: String,
...
#[tauri::command]
pub(crate) fn revoke_external_access(
    raw_path: String,
    scope: String,
) -> Result<ExternalAccessPolicy, String> {
    let canonical_path = canonical_existing_path(&raw_path)?;
...
#[tauri::command]
pub(crate) fn clear_external_access_grants() -> Result<ExternalAccessPolicy, String> {
    let mut policy = db::load_external_access_policy()?;
