...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::save_memory_candidate,
            commands::admit_memory_candidate,
            ...
            commands::sync_user_zone_to_ledger,
            commands::ingest_legacy_memory_md,
            commands::update_memory_entry_content,
            commands::save_memory_recall,
            commands::archive_memory_recall,
            commands::load_latest_memory_recall,
            commands::search_memory_for_recall,
