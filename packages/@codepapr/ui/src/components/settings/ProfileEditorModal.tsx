...
export function ProfileEditorModal({
  ...
  const quickTemplates: QuickTemplate[] = [
    ...
    },
    {
      ...
      apply: (prev) => ({
        name: prev.name || 'OpenCode Go · Kimi K3',
        apiMode: 'custom',
        apiFormat: 'openai',
    ...
    },
    {
      ...
      apply: (prev) => ({
        name: prev.name || 'OpenCode Go · GPT 5.6 Luna',
        apiMode: 'custom',
        apiFormat: 'response',
        baseURL: 'https://opencode.ai/zen/go/v1',
        model: 'gpt-5.6-luna',
    ...
    },
    {
      ...
      apply: (prev) => ({
        name: prev.name || 'OpenCode Go · MiniMax M3',
        apiMode: 'custom',
        apiFormat: 'claude',
        baseURL: 'https://opencode.ai/zen/go/v1',
        model: 'minimax-m3',
    ...
    },
    {
      ...
      apply: (prev) => ({
        name: prev.name || 'OpenRouter Claude Opus 5',
        apiMode: 'custom',
        apiFormat: 'claude',
    ...
    },
    {
      ...
      apply: (prev) => ({
        name: prev.name || 'SiliconFlow V4 Pro',
        apiMode: 'custom',
        apiFormat: 'openai',
    ...
    {
      label: 'OpenAI (GPT-5.6 Luna · Responses)',
      apply: (prev) => ({
        name: prev.name || 'OpenAI GPT-5.6 Luna',
        apiMode: 'custom',
        apiFormat: 'response',
    ...
    {
      label: currentLang === 'en' ? 'Volcengine Ark (Doubao Seed 2.1 Pro · Responses)' : '火山方舟 (Doubao Seed 2.1 Pro · Responses)',
      apply: (prev) => ({
        name: prev.name || '火山方舟 Doubao Seed 2.1 Pro',
        apiMode: 'custom',
        apiFormat: 'response',
    ...
    {
      label: currentLang === 'en' ? 'Gemini Official (3.8 Flash)' : 'Gemini 官方 (3.8 Flash)',
      apply: (prev) => ({
        name: prev.name || 'Gemini 3.8 Flash',
        apiMode: 'custom',
        apiFormat: 'openai',
    ...
    {
      label: currentLang === 'en' ? 'xAI Grok Official (4.6)' : 'xAI Grok 官方 (4.6)',
      apply: (prev) => ({
        name: prev.name || 'xAI Grok 4.6',
        apiMode: 'custom',
        apiFormat: 'openai',
    ...
    {
      label: currentLang === 'en' ? 'Moonshot Kimi Official (kimi-k3)' : 'Kimi 官方 (kimi-k3)',
      apply: (prev) => ({
        name: prev.name || 'Kimi K3',
        apiMode: 'custom',
        apiFormat: 'openai',
    ...
    {
      label: currentLang === 'en' ? 'Z.ai GLM Official (glm-5.3)' : 'GLM 官方 (glm-5.3)',
      apply: (prev) => ({
        name: prev.name || 'Z.ai GLM 5.3',
        apiMode: 'custom',
        apiFormat: 'openai',
