...
pub fn cancel_running_command(token: String) -> Result<bool, String> {
...
pub fn background_process_exit_info(
    pid: u32,
...
pub fn log_ui_event(workspace_path: String, message: String) {
...
/// 进程存活才是判定后端生死的直接证据。
pub fn background_process_alive(pid: u32) -> bool {
...
pub fn start_workspace_shell_background_command(
    workspace_path: String,
    command: String,
    workdir: Option<String>,
    preview_url: Option<String>,
...
pub fn stop_all_background_processes(
    workspace_path: Option<String>,
    source: Option<String>,
