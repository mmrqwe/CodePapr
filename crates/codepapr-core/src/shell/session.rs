...
pub fn read_shell_output(session_id: String) -> Result<ShellReadOutputResult, String> {
    with_shell_sessions(|sessions| {
...
pub fn close_shell_session(session_id: String) -> Result<ShellCloseSessionResult, String> {
